...
if (typeof window !== 'undefined' && typeof document !== 'undefined') {
  ...
  _window = window;
  _document = document;
  _history = BrowserHistory.history;
}
...
exports.boot = function boot(options, callback) {
  ...
  if (useRouter) {
    ...
    // });
    props['routes'] = options.routes;
    props['history'] = _history;
    props['createElement'] = function(Component, objProps) {
      return React.createElement(Component, extend(props, objProps));
    };
    var componentInstance = React.createElement(Router, props);
