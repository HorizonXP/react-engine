...
var Router = util.safeRequire('react-router').Router;
var Location = util.safeRequire('react-router/lib/Location');
  ...
  return function render(thing, options, callback) {
    ...
    try {
      if (this.useRouter) {
        ...
        createOptions.location = new Location(thing);
        ...
        Router.run(createOptions.routes, createOptions.location, (error, initialState, transition) => {
          if (error === null) {
            initialState['createElement'] = (Component, props) => {
              return React.createElement(Component, extend(props, data));
            };
            componentInstance = React.createElement(Router, initialState);
