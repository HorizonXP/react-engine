...
exports.create = function create(createOptions) {
  ...
  return function render(thing, options, callback) {
    ...
    var componentInstance, retVal = null;
    ...
    try {
      if (this.useRouter) {
        ...
        // });
        var routes = createOptions.routes;
        var location = createOptions.location;
        match({ routes, location }, (error, redirectLocation, renderProps) => {
          if (redirectLocation) {
            // redirection
            retVal = redirectLocation;
          } else if (error) {
            retVal = error;
        ...
        if (!componentInstance && retVal != null) {
          // throw(new Error("componentInstance is blank!"));
          return done(retVal);
        }
      } else {
